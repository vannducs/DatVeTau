            ...
            <div style={{ display: "flex", gap: 0, borderBottom: "2px solid #E5E7EB", marginBottom: 20 }}>
                {(["send", "history"] as const).map(t => (
                    <button key={t}
                        ...
                        {t === "send" ? (
                            <><span className="material-icons-round" style={{ fontSize: 15, verticalAlign: "middle", marginRight: 4 }}>send</span>Gửi thông báo</>
                        ) : (
                            <><span className="material-icons-round" style={{ fontSize: 15, verticalAlign: "middle", marginRight: 4 }}>history</span>Lịch sử đã gửi</>
                        )}
                    </button>
                ))}
            </div>
                        ...
                        <table className="admin-table">
                            ...
                            <tbody>
                                {loading ? (
                                    ...
                                    <tr key={n.id}>
                                        <td>
                                            <span className={`admin-badge ${n.noti_type === "broadcast" ? "badge-pending" : n.noti_type === "cancellation" ? "badge-cancelled" : "badge-active"}`}>
                                                {n.noti_type}
                                            </span>
                                        </td>
                                        <td>
