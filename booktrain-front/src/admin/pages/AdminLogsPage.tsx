            ...
            <div style={{ display: "flex", gap: 0, borderBottom: "2px solid #E5E7EB", marginBottom: 20 }}>
                {(["my", "orders"] as const).map(t => (
                    <button key={t}
                        ...
                        {t === "my" ? (
                            <><span className="material-icons-round" style={{ fontSize: 15, verticalAlign: "middle", marginRight: 4 }}>manage_accounts</span>Lịch sử của tôi</>
                        ) : (
                            <><span className="material-icons-round" style={{ fontSize: 15, verticalAlign: "middle", marginRight: 4 }}>receipt_long</span>Lịch sử đặt vé khách hàng</>
                        )}
                    </button>
                ))}
            </div>
